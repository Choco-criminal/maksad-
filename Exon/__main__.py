...
ʜᴇʏ, ɪ’ᴍ {}! 💖
⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯
(⁠◔⁠‿⁠◔⁠) ʏᴏᴜʀ ᴜʟᴛɪᴍᴀᴛᴇ  𝗕𝗢𝗧 ғᴏʀ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ᴀɴᴅ ᴍᴜsɪᴄ sᴛʀᴇᴀᴍɪɴɢ. 
ʟᴇᴛ’s ᴍᴀᴋᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛʜʀɪᴠᴇ ɪɴ sᴛʏʟᴇ! ✨
⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯
● 𝙂𝙧𝙤𝙪𝙥 𝙢𝙖𝙣𝙖𝙜𝙚𝙢𝙚𝙣𝙩
● 𝙎𝙥𝙖𝙢 𝙥𝙧𝙤𝙩𝙚𝙘𝙩𝙞𝙤𝙣
● 𝙈𝙪𝙨𝙞𝙘 𝙨𝙩𝙧𝙚𝙖𝙢𝙞𝙣𝙜
...
● 𝘼𝙄
⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯
ᴡᴀɴᴛ ᴍᴏʀᴇ? ᴛᴀᴘ ᴛʜᴇ ʜᴇʟᴘ ᴍᴇɴᴜ ᴛᴏ ᴜɴʟᴏᴄᴋ ᴀʟʟ ᴍʏ ᴄᴏᴏʟ ғᴇᴀᴛᴜʀᴇs, ᴏʀ ᴅɪᴠᴇ ɪɴᴛᴏ ᴛʜᴇ ᴍᴜsɪᴄ sᴇᴄᴛɪᴏɴ ғᴏʀ ᴀɴ ᴇɴᴅʟᴇss ᴘʟᴀʏʟɪsᴛ ᴏғ ғᴜɴ. 🎶
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇs", url=f"https://t.me/Choco_for_u"),
        
    ],
    [
        InlineKeyboardButton(text="ᴄᴏᴍᴍᴀɴᴅs", callback_data="help_back"),
        InlineKeyboardButton(text="music", url=f"https://t.me/Serpent_hashira_mysic"),
    ],
...
━━━━━━━━━━━━━━━━━━━━━━
I’ve been awake since: <code>{uptime}</code> 😎
But don’t worry, I’m always here to help keep things running smoothly! 🌸
     """    
